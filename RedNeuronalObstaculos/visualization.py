...
def world_to_screen(point, world_size=WORLD_SIZE):
    ...
    x = PADDING + (point[0] / world_size) * drawable_size
...
def _draw_scenario(screen, font, small_font, scenario, metrics_summary):
    ...
    pygame.draw.line(screen, COLOR_IDEAL_PATH, (14, legend_y), (44, legend_y), 3)
    screen.blit(small_font.render("Ruta ideal (geometria)", True, COLOR_TEXT_DIM), (50, legend_y - 8))
    pygame.draw.line(screen, COLOR_PREDICTED_PATH, (260, legend_y), (290, legend_y), 3)
    screen.blit(small_font.render("Ruta predicha (red neuronal)", True, COLOR_TEXT_DIM), (296, legend_y - 8))
